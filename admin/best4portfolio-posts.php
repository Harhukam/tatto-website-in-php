...
$stmt = $user_home ->runQuery('DELETE FROM post WHERE post_id =:bid');
...
$stmt = $user_home->runQuery("SELECT * FROM post WHERE post_cat='best4portfolio' ORDER BY post_id DESC ");
$stmt->execute();
if($stmt->rowCount() > 0)
{
